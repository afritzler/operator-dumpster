...
func main() {
	...
	if err = (&webappcontrollers.GuestbookReconciler{
	...
	// webhooks
	if webhooks.Enabled(cronJobWebhook) {
		if err = (&batchv1alpha1.CronJob{}).SetupWebhookWithManager(mgr); err != nil {
